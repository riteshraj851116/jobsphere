      ...
      <div className="skillgap-container">
        ...
        {loading ? (
          <div style={{ textAlign: "center", padding: "4rem 0" }}>
            <Loader2 size={36} color="#000000" style={{ animation: "spin 1s linear infinite", margin: "0 auto 1rem" }} />
            <h3 style={{ color: "#f1f5f9" }}>Evaluating Skill Match & Calculating Gaps...</h3>
          </div>
        ) : (
          <>
