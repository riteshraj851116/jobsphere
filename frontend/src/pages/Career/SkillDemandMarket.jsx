    ...
    <div className="career-os-container">
      ...
      <div className="career-header-row">
        <div>
          <h1 className="career-os-title" style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <BarChart3 size={28} className="text-primary" /> Skill Demand Intelligence
          </h1>
      ...
      {loading ? (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "4rem 0" }}>
          ...
          <p style={{ marginTop: "1rem", color: "var(--text-secondary)" }}>Aggregating platform market telemetry...</p>
        </div>
      ) : (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              {topSkills.map((sk, idx) => (
                <div key={idx} style={{ display: "flex", flexDirection: "column", gap: "0.25rem" }}>
                  ...
                  <div className="career-progress-track" style={{ height: "7px" }}>
                    <div className="career-progress-fill" style={{ width: `${sk.percentage}%` }} />
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="career-grid-2">
            <div className="career-card">
              <h3 style={{ fontSize: "1.1rem", fontWeight: 700, marginBottom: "0.5rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                <TrendingUp size={18} className="text-primary" /> Emerging High-Growth Skills
              </h3>
            ...
            <div className="career-card">
              <h3 style={{ fontSize: "1.1rem", fontWeight: 700, marginBottom: "0.5rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                <Layers size={18} className="text-primary" /> Active Role Hiring Volume
              </h3>
              <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", marginBottom: "1rem" }}>
